...
const VIDEO_PATHS: Dictionary = {
    ...
    "party": "res://assets/video/party.ogv",
    "unmasked": "res://assets/video/unmasked.ogv",
    "calling": "res://assets/video/calling.ogv",
    "seed": "res://assets/video/seed.ogv",
    "hybrid": "res://assets/video/hybrid.ogv",
    "technophobia": "res://assets/video/technophobia.ogv",
    "invaluable": "res://assets/video/invaluable.ogv",
    "ashes": "res://assets/video/ashes.ogv",
    "waves": "res://assets/video/waves.ogv",
    "rise": "res://assets/video/rise.ogv",
...
func set_max_alpha(value: float) -> void:
    ...
    if _player != null and visible:
        _player.modulate.a = minf(_player.modulate.a, _max_alpha)
...
func _start_video(instant: bool) -> void:
    ...
    if not instant:
        ...
        _fade_tween.tween_property(_player, "modulate:a", _max_alpha, 0.34)
