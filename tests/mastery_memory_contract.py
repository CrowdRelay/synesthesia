...
assert 'max_resonance_chain' in metrics[metrics.index('static func room_mastery('):metrics.index('static func record_room_mastery(')], 'resonance skill loop must feed local mastery'
...
assert 'REZONANS %s · %d/100' in completion
