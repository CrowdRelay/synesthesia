...
checks = [
    ...
    ('bootVideoTimer = window.setTimeout(armBootVideo, 420)', web_js, "fast-boot loop deferral"),
    ('connection?.saveData', web_js, "data-saver boot guard"),
    ('if (removed || migrationActive || warmBoot) return false;', web_js, "warm-boot decoder guard"),
