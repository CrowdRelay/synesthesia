...
for token in (
    ...
    'GDScript Web fallback must not ship Rust side-module WASM',
    'SYNESTHESIA_RUST_WEB_REQUIRED',
...
print('SYNESTHESIA_WEB_BUNDLE_BUDGET_CONTRACT=PASS preflight<=64MiB pck<=72MiB rust=required-or-zero-fallback total<=128MiB')
