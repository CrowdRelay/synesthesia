...
checks = {
    ...
    "cached network header timeout": "const NETWORK_HEADER_TIMEOUT_MS = 3500" in worker and "Promise.race([networkPromise, networkHeaderTimeout()])" in worker,
...
print("SYNESTHESIA_RELEASE_HARDENING_V3=PASS pwa=atomic+scoped+range-safe save=bounded+self-healing draw=packed+static")
